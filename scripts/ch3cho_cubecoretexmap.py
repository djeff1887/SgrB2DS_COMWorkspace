...
ch3cho_sourcelocs={'SgrB2S':'','DSi':'','DSii':'','DSiii':'','DSiv':'','DSv':'','DSVI':'','DSVII':''}
...
representativelines={'SgrB2S':'','DSi':'','DSii':'','DSiii':'','DSiii':'','DSiv':'','DSv':'','DSVI':'','DSVII':''}
representativelws=measlinewidth
representativecubes={'SgrB2S':'','DSi':'','DSii':'','DSiii':'','DSiv':'','DSv':'','DSVI':'','DSVII':'','DSVIII':'','DSIX':'','DSX':''}

excludedlines={'SgrB2S':[],
               'DSi':[],
               'DSii':[],
               'DSiii':[],
               'DSiv':[],
...
catdir_ch3cho=catdir[catdir['tag'] == ]
catdir_qrot300=10**catdir_ch3cho['lg(Q(300))']

restfreq_representativeline={'SgrB2S':'','DSi':'','DSii':'','DSiii':'','DSiv':'','DSv':'','DSVI':'','DSVII':'','DSVIII':'','DSIX':'','DSX':''}
